...
class ExceptionsSimpleTest : TestCase() {
    ...
    fun testExceptionMessageFormatting() {
        ...
        val exception = PhotoCaptureException(fullMessage)
    ...
    fun testMultipleExceptionTypes() {
        val exceptions = listOf(
            PhotoCaptureException("Camera failed"),
            PermissionDeniedException("No permission"),
            ImageProcessingException("Processing failed")
        )
        
        exceptions.forEach { exception ->
            assertNotNull("Exception should not be null", exception)
            assertTrue("Exception should be ImagePickerException", exception is ImagePickerException)
            assertNotNull("Exception message should not be null", exception.message)
            assertTrue("Exception message should not be empty", exception.message!!.isNotEmpty())
        }
    }
}
