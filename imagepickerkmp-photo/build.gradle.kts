...
A Kotlin Multiplatform imagepickerkmp-photo for image picking with camera support, compiled to JavaScript for use in web applications.

## Quick Start

```javascript
// Import the imagepickerkmp-photo
...
tasks.register("validateNpmPackage") {
    ...
    doLast {
        ...
        val mainJs = File(packageDir, "kotlin/ImagePickerKMP-imagepickerkmp-photo.js")
        ...
        val requiredFiles = listOf(
            ...
            mainJs to "kotlin/ImagePickerKMP-imagepickerkmp-photo.js",
...
tasks.register<Exec>("publishNpmLocal") {
    ...
    // Use production imagepickerkmp-photo directory with the bundle
...
/*tasks.register<Exec>("createZeroConfigBundle") {
    ...
    doLast {
        ...
        val bundleFile1 = File(rootBuildDir, "js/packages/ImagePickerKMP-imagepickerkmp-photo/ImagePickerKMP-bundle.js")
        val bundleFile2 = File(rootBuildDir, "js/packages/imagepickerkmp-photo-imagepickerkmp-photo/ImagePickerKMP-bundle.js")
        ...
        if (bundleFile != null && bundleFile.exists()) {
            ...
            // Copy to the production imagepickerkmp-photo directory for npm publishing
            val productionLibDir = layout.buildDirectory.dir("dist/js/productionLibrary").get().asFile
            ...
            println("Bundle copied to production imagepickerkmp-photo directory: ${targetBundle.absolutePath}")
            
            // Also copy TypeScript declarations if they exist
            val bundleTypeFile1 = File(rootBuildDir, "js/packages/ImagePickerKMP-imagepickerkmp-photo/ImagePickerKMP-bundle.d.ts")
            val bundleTypeFile2 = File(rootBuildDir, "js/packages/imagepickerkmp-photo-imagepickerkmp-photo/ImagePickerKMP-bundle.d.ts")
...
tasks.register("buildNpmZeroConfig") {
    ...
    doLast {
        val packageDir = layout.buildDirectory.dir("js/packages/${project.name}-imagepickerkmp-photo").get().asFile
...
// Isolation rule: Image module must NOT depend on Video module (Requirement 4.1, 4.8)
configurations.all {
    resolutionStrategy {
        eachDependency {
