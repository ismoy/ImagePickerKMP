...
import io.github.ismoy.imagepickerkmp.config.ImagePickerUiConstants.GALLERY_FILE_UTILS_TAG
...
internal object GalleryFileUtils {
    ...
    fun getFileName(context: Context, uri: Uri): String? {
        ...
        val cursor = try {
            ...
            PhotoLogger.debug("$GALLERY_FILE_UTILS_TAG ${e.javaClass.simpleName}")
            null
        }
        cursor?.use {
            if (it.moveToFirst()) {
