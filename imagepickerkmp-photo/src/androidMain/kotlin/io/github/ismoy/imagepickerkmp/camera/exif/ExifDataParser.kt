...
import io.github.ismoy.imagepickerkmp.config.ImagePickerUiConstants.EXTRACTION_EXIF_FAILED_TAG
import io.github.ismoy.imagepickerkmp.config.ImagePickerUiConstants.INPUT_DATE_FORMAT
import io.github.ismoy.imagepickerkmp.config.ImagePickerUiConstants.NUMBER_MINUS_ONE
import io.github.ismoy.imagepickerkmp.config.ImagePickerUiConstants.NUMBER_MINUS_ONE_DOT_ZERO
...
import io.github.ismoy.imagepickerkmp.config.ImagePickerUiConstants.N_A
...
internal object ExifDataParser {
    ...
    private fun extractThumbnail(exif: ExifInterface): String? {
        return try {
            ...
            PhotoLogger.debug("$EXTRACTION_EXIF_FAILED_TAG- file descriptor issue")
            null
        } catch (e: Exception) {
            PhotoLogger.debug("$EXTRACTION_EXIF_FAILED_TAG ${e.javaClass.simpleName}")
            null
        }
    }
}
