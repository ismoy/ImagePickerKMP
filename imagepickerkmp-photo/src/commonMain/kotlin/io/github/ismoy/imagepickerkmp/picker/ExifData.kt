...
data class ExifData(
     ...
     * (i.e. [io.github.ismoy.imagepickerkmp.config.GalleryConfig.redactGpsData] or
     * [io.github.ismoy.imagepickerkmp.config.CameraCaptureConfig.redactGpsData] is `true`).
     */
